...
public class RegisterUser {
	...
	public static void main(String[] args) {
		...
		User user1 = new User(1, "Bhirahatees", "bhirahatees@gmail.com");
		User user2 = new User(2, "Periyasamy", "periysamy@gmail.com");
		User user3 = new User(3, "Bhirahatees", "bhirahatees@gmail.com");
